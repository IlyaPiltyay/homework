...
def filter_by_currency(transactions: Dict, usd: str) -> Iterator[str]:
    """возвращение id со статусом USD"""
    for key in transactions:
        if key["operationAmount"]["currency"]["code"] == usd:
            yield key["id"]
...
def transaction_descriptions(info: Dict) -> Iterator[str]:
    """Типы операций"""
